...
type PublicProfileDetailScreenProps = {
  navigation: NativeStackNavigationProp<
    RootStackParamList,
    "PublicProfileDetail"
  >;
  route: RouteProp<RootStackParamList, "PublicProfileDetail">;
};

const PublicProfileDetailScreen: React.FC<PublicProfileDetailScreenProps> = ({
  navigation,
  route,
}) => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50" edges={["top"]}>
      <ScreenHeader title="Perfil Público" onBack={() => navigation.goBack()} />
      ...
      >
          ...
          <View className="items-center">
            ...
            <View className="flex-row items-center justify-around">
              ...
              {profile.favorite_exercises &&
                profile.favorite_exercises.length > 0 && (
                  <View className="items-center">
                    <View className="flex-row items-center mb-1">
                      <FontAwesome5 name="heart" size={16} color="#EF4444" />
                      <Text className="ml-2 text-xl font-bold text-gray-800">
        ...
        {profile.personal_records &&
          profile.personal_records.recent.length > 0 && (
            <View className="bg-white mx-4 mt-4 rounded-lg p-4">
              ...
              {profile.personal_records.total_count >
                profile.personal_records.recent.length && (
        ...
        {!profile.personal_records && !profile.favorite_exercises && (
          <View className="bg-white mx-4 mt-4 rounded-lg p-8">
            <View className="items-center">
              ...
              <Text className="text-gray-600 mt-2 text-center">
                Este usuario ha elegido mantener privados sus records personales
                y ejercicios favoritos
              </Text>
            </View>
          </View>
        )}
